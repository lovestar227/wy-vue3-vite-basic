...
const minLT2 = minLT + (maxLT - minLT) * 0.2;
const maxHT2 = maxHT - (maxHT - minHT) * 0.2;
...
console.log(minLT2, maxHT2, highPieces, lowPieces);

const temperatureChartOption: ECOption = {
  xAxis: {
    type: "category",
    boundaryGap: false
  },
