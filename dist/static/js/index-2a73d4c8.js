...
import { _ as m } from "./index-4903d644.js";
...
const Fe = m(be, [["__scopeId", "data-v-579823ad"]]),
  xe = s => (O("data-v-4665cbcd"), (s = s()), T(), s),
  ke = { class: "home-updateLog" },
  Ae = { class: "log-list" },
  we = { class: "version" },
  Ce = xe(() => n("br", null, null, -1)),
  Be = l({ name: "UpdateLog" }),
  De = l({
    ...Be,
    setup(s) {
...
const Se = m(De, [["__scopeId", "data-v-4665cbcd"]]),
  We = { class: "home-page" },
