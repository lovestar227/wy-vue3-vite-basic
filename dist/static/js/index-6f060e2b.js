...
import { _ as H } from "./index-649cc330.js";
const E = {
    class: "icon-svg",
...
const X = { name: "ep-school", render: Q },
  Y = L({
    name: "WyPopoverListItem",
    __name: "WyPopoverListItem",
    props: {
      item: { default: null },
    ...
    setup(_, { emit: v }) {
      const e = _,
        k = R(() => (typeof e.item == "object" ? e.item[e.showField] : e.item)),
        r = o => {
      ...
      return (o, h) => (
        ...
        B(
          ...
          {
            class: D(["wy-item", p()]),
            onClick: h[0] || (h[0] = c => r(o.item))
          },
          [V(o.$slots, "default", {}, () => [f(I(n(k)), 1)], !0)],
          2
        )
      );
    }
  });
const Z = H(Y, [["__scopeId", "data-v-e985ddec"]]),
  ee = {
    class: "icon-svg",
    viewBox: "0 0 1024 1024",
    width: "1.2em",
...
const ie = { name: "ep-search", render: se },
  oe = { class: "wy-popover-header" },
  ae = { key: 0, class: "wy-search" },
  ne = { class: "wy-popover-footer" },
  de = L({
    name: "WyPopoverList",
    __name: "index",
    props: {
          ...
          e.modelValue &&
            ...
            (e.valueField
              ? ((c.value = e.list.filter(
                ...
                (F.value = c.value[e.keyField]))
              : ((c.value = e.modelValue), (F.value = c.value[e.keyField])));
        };
      return (
        T(() => {
        ...
        (s, m) => {
          ...
          return (
            ...
            U(
              ...
              {
                reference: t(() => [
                  V(s.$slots, "reference", { result: n(p) }, () => [
                    i(
                      w,
                      {
                        modelValue: n(p),
                        "onUpdate:modelValue":
                          m[0] || (m[0] = z => (b(p) ? (p.value = z) : null)),
                        readonly: "",
                        class: D([
                          "wy-trigger-input",
                ...
                default: t(() => [
                  l("div", oe, [V(s.$slots, "header", { hidePopover: r })]),
                  e.showSearch
                    ? ($(),
                      B("div", ae, [
                        i(
                    ...
                    : K("", !0),
                  V(s.$slots, "default", { hidePopover: r }, () => [
                    i(
                      P,
                      {
                        class: D(
                  ...
                  l("div", ne, [V(s.$slots, "footer", { hidePopover: r })])
                ]),
                _: 3
              },
              8,
...
const C = _ => (j("data-v-764bc0f8"), (_ = _()), A(), _),
  ue = { class: "list-page" },
  ce = C(() => l("h1", null, "输入框弹出式列表选择组件", -1)),
  re = C(() =>
    l(
      "ul",
      null,
  ...
  he = { class: "w-200px inline-block" },
  ye = C(() => l("h3", null, "当ElPopover使用", -1)),
  ge = { class: "w-200px" },
  we = C(() => l("h3", null, "提供了内容的header、footer slot", -1)),
  ke = { class: "w-200px" },
  Fe = L({
    name: "ListPage",
    __name: "index",
...
const Ve = H(Fe, [["__scopeId", "data-v-764bc0f8"]]);
