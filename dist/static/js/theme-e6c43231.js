...
import { _ as D, b as W, g as M, s as C, c as R } from "./index-649cc330.js";
const L = {
        ...
        S(
          ...
          n => {
            s === n
              ...
              : s
              ? (r.value.style.transform = `translateX(calc( -${l.value.clientWidth}px + 100% + 2px))`)
              : s ||
                (r.value.style.transform = `translateX(calc( ${l.value.clientWidth}px - 100% - 2px))`);
          }
        ),
                    ...
                    [
                      _(
                        a(
                          "span",
                          H,
                          [y(n.$slots, "open-circle", {}, void 0, !0)],
                          512
                        ),
                        [[g, e.modelValue]]
                      ),
                      _(
                        a(
                          "span",
                          P,
                          [y(n.$slots, "close-circle", {}, void 0, !0)],
                          512
                        ),
                        [[g, !e.modelValue]]
                      )
...
const U = D(Q, [["__scopeId", "data-v-a1608f1c"]]),
  Y = b({
    name: "WyDarkToogle",
    __name: "index",
    emits: ["change"],
    setup(o, { emit: t }) {
      ...
      return (c, l) => (
        ...
        B(
          ...
          {
            "open-circle": x(() => [v(i(N), { style: { color: "#fff" } })]),
            "close-circle": x(() => [v(i(G))]),
            _: 1
          },
          8,
          ["model-value"]
  ...
  Z = T({
    id: "Theme",
    state: () => ({ themeColor: W() ?? M().themeColor }),
    getters: {
      getThemeColor(o) {
        return o.themeColor;
      }
    ...
    actions: {
      setThemeColor(o) {
        const t = C.getItem("themeColor") || {};
        Object.assign(t, this.themeColor, o),
          (this.themeColor = t),
          C.setItem("themeColor", t),
          R(o);
      }
    }
  });
export { Y as _, Z as t };
